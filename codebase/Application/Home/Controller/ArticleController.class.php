...
class ArticleController extends HomeController
{
    public function index($id = 19)
    {
        ...
        $ArticleTypeList = M('ArticleType')->where(array('status' => 1, 'index' => 1))->order('sort asc ,id asc')->select();
    ...
    {
        $data['title'] = "This is a custom page";
        $data['content'] = "Custom Description";
    ...
    public function type($id = NULL)
    {
        ...
        $this->assign('ArticleTypeList', $ArticleTypeList);
        $this->assign('data', $Articleaa);
        $this->assign('page_title', $Articleaa['title'] . ' | ' . $shang['title']);
        $this->display();
    }
