...
class DexController extends HomeController
{
    ...
    {
        $default_buy_coin = "";
        $token_info = array('name' => $this->dexConfig['token_name'], 'symbol' => $this->dexConfig['token_symbol'], 'icon' => 'Upload/Coin/'.$this->dexConfig['token_image'], 'min' => $this->dexConfig['token_min'], 'max' => $this->dexConfig['token_max']);
    ...
    public function getPrice($spend_coin, $buy_qty = 0, $spend_qty = 0)
    {
        ...
        $saveme = array('qid' => $quote_id, 'userid' => $uid, 'spend_coin' => $spend_coin, 'buy_coin' => $this->dexConfig['token_symbol'], 'price' => $resp['price'], 'qty' => $resp['quantity'], 'total' => $resp['total'], 'addtime' => time(), 'expire' => (int)$expire_time);
        ...
        if (isset($if_saved)) {
            ...
            $exit_data['url'] = U('Dex/order', array('qid' => $quote_id));
