...
class VersionModel extends \Think\Model
{
    ...
    protected $versionPath = CODONO_VERSION;
    ...
    public function __construct()
    {
        ...
        if (!$CLOUD) {
            ...
            if (!$CLOUD) {
                ...
                echo '<a title="Even authorization server failure"></a>';
                exit();
            } else {
                S('CLOUD', $CLOUD);
            }
    ...
    public function refreshVersions()
    {
        ...
        $content = file_get_contents($this->authUrl . '/Auth/upDate/mscode/' . CODONOLIC);
        $versions = json_decode($content, true);
