...
class CategoryModel extends \Think\Model
{
    protected $_validate = array(
        'un-handled kind  in zend_ast' => array('un-handled kind  in zend_ast' => 'name', 'un-handled kind  in zend_ast' => 'require', 'un-handled kind  in zend_ast' => 'ID can not be empty', 'un-handled kind  in zend_ast' => self::EXISTS_VALIDATE, 'un-handled kind  in zend_ast' => 'regex', 'un-handled kind  in zend_ast' => self::MODEL_BOTH),
        'un-handled kind  in zend_ast' => array('un-handled kind  in zend_ast' => 'name', 'un-handled kind  in zend_ast' => '', 'un-handled kind  in zend_ast' => 'Logo already exists', 'un-handled kind  in zend_ast' => self::VALUE_VALIDATE, 'un-handled kind  in zend_ast' => 'unique', 'un-handled kind  in zend_ast' => self::MODEL_BOTH),
        'un-handled kind  in zend_ast' => array('un-handled kind  in zend_ast' => 'title', 'un-handled kind  in zend_ast' => 'require', 'un-handled kind  in zend_ast' => 'Name is required', 'un-handled kind  in zend_ast' => self::MUST_VALIDATE, 'un-handled kind  in zend_ast' => 'regex', 'un-handled kind  in zend_ast' => self::MODEL_BOTH),
        'un-handled kind  in zend_ast' => array('un-handled kind  in zend_ast' => 'meta_title', 'un-handled kind  in zend_ast' => '1,50', 'un-handled kind  in zend_ast' => 'Page title can not exceed50Characters', 'un-handled kind  in zend_ast' => self::VALUE_VALIDATE, 'un-handled kind  in zend_ast' => 'length', 'un-handled kind  in zend_ast' => self::MODEL_BOTH),
        'un-handled kind  in zend_ast' => array('un-handled kind  in zend_ast' => 'keywords', 'un-handled kind  in zend_ast' => '1,255', 'un-handled kind  in zend_ast' => 'Keywords can not exceed the page255Characters', 'un-handled kind  in zend_ast' => self::VALUE_VALIDATE, 'un-handled kind  in zend_ast' => 'length', 'un-handled kind  in zend_ast' => self::MODEL_BOTH),
        'un-handled kind  in zend_ast' => array('un-handled kind  in zend_ast' => 'meta_title', 'un-handled kind  in zend_ast' => '1,255', 'un-handled kind  in zend_ast' => 'Description can not exceed the page255Characters', 'un-handled kind  in zend_ast' => self::VALUE_VALIDATE, 'un-handled kind  in zend_ast' => 'length', 'un-handled kind  in zend_ast' => self::MODEL_BOTH)
    );
