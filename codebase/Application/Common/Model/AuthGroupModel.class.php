...
class AuthGroupModel extends \Think\Model
{
    ...
    protected $_validate = array(
        'un-handled kind  in zend_ast' => array('un-handled kind  in zend_ast' => 'title', 'un-handled kind  in zend_ast' => 'require', 'un-handled kind  in zend_ast' => 'You must set a user group title', 'un-handled kind  in zend_ast' => \Think\Model::MUST_VALIDATE, 'un-handled kind  in zend_ast' => 'regex', 'un-handled kind  in zend_ast' => \Think\Model::MODEL_INSERT),
        'un-handled kind  in zend_ast' => array('un-handled kind  in zend_ast' => 'description', 'un-handled kind  in zend_ast' => '0,80', 'un-handled kind  in zend_ast' => 'Description Up80character', 'un-handled kind  in zend_ast' => \Think\Model::VALUE_VALIDATE, 'un-handled kind  in zend_ast' => 'length', 'un-handled kind  in zend_ast' => \Think\Model::MODEL_BOTH)
    );
