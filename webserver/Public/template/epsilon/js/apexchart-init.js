(function ($) {
	...
	$(document).on('click', '#one_month', function (e) {
		resetCssClasses(e)
		chart.updateOptions({
			xaxis: {
				min: new Date('20 Jun 2021').getTime(),
				max: new Date('19 July 2021').getTime()
			}
		})
	});
	$(document).on('click', '#six_months', function (e) {
		resetCssClasses(e)
		chart.updateOptions({
			xaxis: {
	...
	$(document).on('click', '#one_year', function (e) {
		resetCssClasses(e)
		chart.updateOptions({
			xaxis: {
				min: new Date('20 July 2020').getTime(),
				max: new Date('19 July 2021').getTime()
			}
		})
	});
	...
	function generateDayWiseTimeSeries(s, count) {
		...
		var i = 0;
		var series = [];
		var x = new Date("19 Jun 2020").getTime();
		while (i < count) {
