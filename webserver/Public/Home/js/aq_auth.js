(function(b,g){
	var f=function(){
		...
		this.authTypeMap={realname:"Real-name verification",personal:"personalverification",business:"Industry-proven",official:"Official website validation",enterprise:"Enterprises verification"};
	...
	f.prototype={
		...
		fixedSymbol:function(k,t){
			...
			var s={auth_type:o.authTypeMap[t],star:l,name:k.org_name,type:k.site_type,year:"The first"+k[j+"_verify_year"]+"year",profile_url:o._AQ_profile_url+k.domain+"?tab=comment",credit_url:o._AQ_credit_url+"?domain="+k.domain,certificate_url:o._AQ_certificate_url+"?site="+k.domain+"&at="+t};
			var u=r.join("");
			for( var qins){
			...
			a[h]=function(n,s,o){
				...
				if(l==="fixed"){
					...
					m.style.border="none";
					m.setAttribute("alt","Security Alliance Certification");
